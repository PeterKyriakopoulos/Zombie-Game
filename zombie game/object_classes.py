# -*- coding: utf-8 -*-
"""
Created on Wed Oct 12 17:18:17 2016
    ...
    def __init__(self, x, y, velx, vely, direction, type_):
        ...
        if type_ == 'shotgun' or type_ == 'pistol' or type_ == 'automatic':
            try:
                ...
                if dx < 200 and dy < 200 and type_ == 'shotgun':
                    return
                if dx < 120 and dy < 120 and type_ == 'pistol':
                    return
                if dx < 25 and dy < 25 and type_ == 'automatic':
                    return
            except: pass

        self.type = type_
        self.direction = direction
        self.velx, self.vely = velx//2, vely//2
